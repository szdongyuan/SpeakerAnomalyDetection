...
AUDIO_DATA_TABLE_COLUMNS = ', '.join(['audio_data_id', 'file_path', 'product_model',
                                      'sample_rate', 'recode_date', 'labels', 'sweep_id'])
...
SELECT_COLUMNS = ', '.join(['file_path', 'product_model', 'recode_date', 'sweep_type', 'sweep_duration', 'audio_data_table.sweep_id', 'labels'])
