...
def _run_loudness(
    ...
    try:
        ...
        analysis_signal = _apply_loudness_noise_reduction(
            analysis_signal,
            sample_rate_int,
            advanced_cfg,
        )
    ...
    requested_metrics = _requested_loudness_summary_metrics(
        display_cfg,
        save_cfg,
        advanced_cfg,
        required_metrics=loud_cfg.get("required_summary_metrics", []),
    )
...
def _apply_loudness_time_range(
    ...
    if end_sample <= start_sample:
        raise ValueError("analysis time range does not contain any audio samples")
    return (
...
def _requested_loudness_summary_metrics(
    display_cfg: dict,
    save_cfg: dict,
    advanced_cfg: dict,
    *,
    ...
    configured.extend(required_metrics or [])
    return {
