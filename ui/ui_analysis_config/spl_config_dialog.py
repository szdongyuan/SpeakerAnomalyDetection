...
class SplConfigWindow(QDialog):
    ...
    def create_upper_lower_layout(self):
        ...
        self.spinbox_upper.setRange(0, 500)
        self.spinbox_upper.setValue(float(self.load_config.get("upper_limit")))
        self.spinbox_upper.textChanged.connect(self.get_default_config)
        ...
        upper_layout.addWidget(self.spinbox_upper)
