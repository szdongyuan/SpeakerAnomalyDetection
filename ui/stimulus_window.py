...
class StimulusWindow(QDialog):
    ...
    STEP_SC_VALID_MODES = set(STEP_SC_MODE_LABELS)
    ...
    STEP_SC_VALID_RESOLUTIONS = {"R3", "R10", "R20", "R40", "R80"}
    ...
    def create_step_sc_group_box(self):
        step_sc_group_box = GroupBox("step(sc)")
    ...
    def _is_step_sc_active(self):
        return normalize_stimulus_method(self.stimulus_info.get("stimulus_method")) == "frequency_stepped"
    ...
    def _ensure_step_sc_defaults(self):
        self.stimulus_info["stimulus_method"] = "frequency_stepped"
        self.stimulus_info["stimulus_label"] = "step(sc)"
    ...
    def _is_missing_legacy_external_path_payload(stimulus_info, payload):
        return (
            normalize_stimulus_method(stimulus_info.get("stimulus_method")) != "frequency_stepped"
    ...
    def _prepare_frequency_stepped_info(self, stimulus_info):
        ...
        if mode not in self.STEP_SC_VALID_MODES:
            ...
            mode = stimulus_type
        repaired["stimulus_method"] = "frequency_stepped"
        repaired["stimulus_label"] = "step(sc)"
    ...
    def _strip_step_sc_rich_metadata(self, stimulus_info):
        ...
        if cleaned.get("stimulus_method") != "frequency_stepped":
    ...
    def _generate_frequency_stepped_candidate(self, candidate, retained, retained_state):
        ...
        generated_info["stimulus_method"] = "frequency_stepped"
        generated_info["stimulus_label"] = "step(sc)"
    ...
    def switch_group_box_availability(self, enable_status=True):
        ...
        self.step_sc_group_box.setVisible(stimulus_method == "frequency_stepped")
        if enable_status:
    ...
    def set_stimulus_type_connection(self):
        ...
        legacy_switch_from_step_sc = previous_method == "frequency_stepped" and target_method != "frequency_stepped"
        ...
        method_entry_snapshot = (
            ...
            if target_method == "frequency_stepped" and previous_method != "frequency_stepped"
            else None
        )
        ...
        if self.stimulus_info["stimulus_method"] != "frequency_stepped":
        ...
        if stimulus_method == "啁啾":
            ...
            self.custom_chk_box.blockSignals(False)
            self.stimulus_info["use_custom_stimulus"] = True
            if previous_method != "frequency_stepped" and self._step_sc_retained_frequency_state not in {
                "clean",
                "dirty",
            }:
                self._step_sc_retained_frequency_state = "none"
        ...
        if legacy_switch_from_step_sc:
            ...
            if not restored_external_branch and not self.load_stimulus_signal_path:
                self._clear_loaded_legacy_external_paths()
        if self.stimulus_info.get("stimulus_method") != "frequency_stepped" and self.stimulus_info.get(
    ...
    def _create_frequency_stepped_signal_from_info(self):
        ...
        try:
            ...
            MessageBox.warning(self, "step(sc)", str(exc))
            return False
    ...
    def _build_step_sc_stimulus_filename(self):
        ...
        return filename[:160].rstrip(".-_") or "frequency_stepped"
    ...
    def update_stimulus_ui_value(self, stimulus_info: dict):
        ...
        if stimulus_info.get("stimulus_method") == "frequency_stepped":
            try:
        ...
        self._sync_current_legacy_stimulus_type()
        octave_mode = (
            stimulus_info.get("stimulus_method") == "frequency_stepped"
    ...
    def load_config_btn_clicked(self):
        ...
        elif loaded_stimulus.get("stimulus_method") == "frequency_stepped":
            try:
    ...
    def load_stimulus_config_data(self, stimulus_data):
        ...
        if unsupported_method_fallback:
            ...
            self.stimulus_data, _ = StimulusSignal().generate_chirps(**self.stimulus_info)
        elif self.stimulus_info.get("stimulus_method") == "frequency_stepped":
            try:
        ...
        if (
            ...
            and self.stimulus_info.get("stimulus_method") != "frequency_stepped"
    ...
    def default_config_btn_clicked(self):
        ...
        elif candidate.get("stimulus_method") == "frequency_stepped":
            try:
