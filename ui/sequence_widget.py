...
class SequenceWindow(QWidget):
    ...
    def create_left_layout(self):
        ...
        ng_layout.addStretch()
        self.ok_btn.setIcon(QIcon(DEFAULT_DIR + "ui/ui_pic/sequence_pic/red_circle.png"))
        ...
        self.ng_btn.setIcon(QIcon(DEFAULT_DIR + "ui/ui_pic/sequence_pic/green_circle.png"))
