...
def main_host(service, tmp_path, *, streaming=True, monitor=False):
    ...
    def begin_recent_session():
        ...
        host._current_recent_session_id = "capture-placeholder"
        host.recent_test_session_by_id = {"capture-placeholder": {"state": "recording"}}
    host._begin_recent_session_for_current_run = begin_recent_session
