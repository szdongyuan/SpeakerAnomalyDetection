...
def test_import_does_not_load_sdk():
    ...
    program = textwrap.dedent("""
        ...
        def forbidden_native_io(*args, **kwargs):
            raise AssertionError("unexpected disk access or native DLL loading")

        ctypes.CDLL = forbidden_native_io
        ctypes.WinDLL = forbidden_native_io
        os.add_dll_directory = forbidden_native_io
        Path.is_file = forbidden_native_io

        import base.vkinging_sdk as sdk
